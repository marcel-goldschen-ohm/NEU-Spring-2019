...
5. Launch Spyder. Go to Preferences->Python interpreter. Check 'Use the following python interpreter:' and select the python executable for the environment you created above. The location will depend on your OS and whether you installed for all users or just your own user account. For a MacOSX all users install, the path should be something like '/anaconda3/envs/neuroS2019/python' (replace neuroS2019 with the environment name you chose). The same on Windows should be something like 'C:\ProgramData\Anaconda3\envs\...'. If you installed for your own account only the path may be in your user directory (e.g. /Users/USERNAME/anaconda3/envs/...). You may have to restart Spyder.
